...
# pretrained = 'all_data_checkpoints/anomaly_ov3_7B_only_llm_and_projector_all_data'
pretrained = "checkpoints_reduced_data/anomaly_ov3_7B_only_llm_and_projector_only_reduced_data"
...
with open('h100b_anomalyov3_7b_reduced_data_reasoning_responses.json', 'w') as f:

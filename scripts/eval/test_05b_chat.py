...
pretrained = 'checkpoints/anomaly_ov3_05B_only_llm_and_projector_all_data'
...
tokenizer, model, image_processor, max_length = load_pretrained_model(pretrained, None, model_name, device_map=device_map, cache_dir='/home/idwivedi/Anomaly_OV3/cache/', torch_dtype="bfloat16") #, overwrite_config=overwrite_config)
...
for d in data:
    ...
    question = DEFAULT_IMAGE_TOKEN + "\nDo you see any anomalies in the image?"

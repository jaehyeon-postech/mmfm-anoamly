...
pretrained = "a100a_checkpoints/anomaly_ov3_7B_only_llm_and_projector_only_our_data_big"
...
with open('a100a_anomalyov3_7b_only_our_data_big_yes_no_responses.json', 'w') as f:
